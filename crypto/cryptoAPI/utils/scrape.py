...
class Scrape:
    ...
    def scrape_ethereum_price(self):
        try:
            req = Request('https://www.coingecko.com', headers={'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.182 Safari/537.36'})
            html = urlopen(req).read()
            bs = BeautifulSoup(html, 'html.parser')
